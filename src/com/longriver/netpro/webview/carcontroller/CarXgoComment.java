...
public class CarXgoComment {
	public static boolean process = false;
	public static boolean isSend = false;
	public static void main(String[] args) {
		process = true;
		TaskGuideBean task = new TaskGuideBean();
		task.setAddress("http://top.chinaz.com/site_www.xgo.com.cn.html");
		...
		WebDriver driver = null;
						...
						//		profile.setPreference("permissions.default.image", 2);
								...
								try {
									...
									commit.click();
									Thread.sleep(1000 * 2);//*[@id="SOHU_MAIN"]/div[7]/div/div[2]/div[3]/div[3]/input
									WebElement name = driver.findElement(By.xpath("//*[@id='SOHU_MAIN']/div[7]/div/div[2]/div[3]/div[3]/input"));
									name.clear();
									name.click();
									name.sendKeys(task.getNick());
									Thread.sleep(1000 * 2);
									try {
										WebElement error = driver.findElement(By.xpath("//*[@id='SOHU_MAIN']/div[7]/div/div[2]/div[3]/div[5]/span[1]"));
									...
									WebElement getWord = driver.findElement(By.xpath("//*[@id='SOHU_MAIN']/div[7]/div/div[2]/div[3]/div[4]/span"));
									getWord.click();
									Thread.sleep(1000 * 2);//*[@id="SOHU_MAIN"]/div[8]/div/img
									WebElement imgCode = driver.findElement(By.xpath("//*[@id='SOHU_MAIN']/div[8]/div/img"));
									yzmInput(driver,imgCode,1);
									Thread.sleep(1000 * 2);//*[@id="SOHU_MAIN"]/div[7]/div/span[2]
									WebElement sure = driver.findElement(By.xpath("//*[@id='SOHU_MAIN']/div[8]/div/span[2]"));
									sure.click();
									Thread.sleep(1000 * 2);
									try {
										WebElement errorMsg = driver.findElement(By.xpath("//*[@id='SOHU_MAIN']/div[8]/div/span[1]"));
									...
									WebElement password = driver.findElement(By.xpath("//*[@id='SOHU_MAIN']/div[7]/div/div[2]/div[3]/div[4]/div/input"));
									password.clear();
									password.click();
									...
									Thread.sleep(1000 * 2);
									WebElement login = driver.findElement(By.xpath("//*[@id='SOHU_MAIN']/div[7]/div/div[2]/div[3]/span"));
									login.click();
									try {
										WebElement error = driver.findElement(By.xpath("//*[@id='SOHU_MAIN']/div[7]/div/div[2]/div[3]/div[5]/span[2]"));
										isSuccess(task, error.getText());
										return;
									} catch (Exception e) {
	...
	public static void yzmInput(WebDriver driver,WebElement imgCode,int yzmcode){
		...
		driver.findElement(By.xpath("//*[@id='SOHU_MAIN']/div[8]/div/div[3]/input")).clear();
		driver.findElement(By.xpath("//*[@id='SOHU_MAIN']/div[8]/div/div[3]/input")).sendKeys(code);
