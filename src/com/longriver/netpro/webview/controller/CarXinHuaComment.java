...
public class CarXinHuaComment {
	
	private static Logger logger = Logger.getLogger(CarXinHuaComment.class);
	...
	public static void main(String arsg[]){
		try{
			...
			b.setAddress("http://news.xinhuanet.com/world/2016-04/21/c_1118692581.htm");
			b.setCorpus("看看是谁");
			xinhua(b);
		}catch(Exception e){
			e.printStackTrace();
