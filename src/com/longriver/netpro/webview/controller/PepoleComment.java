...
public class PepoleComment {
	
	private static Logger logger = Logger.getLogger(PepoleComment.class);
	public static void main(String arsg[]){
		try{
			TaskGuideBean b = new TaskGuideBean();
			b.setNick("wolffirm@163.com");
			b.setPassword("wangmeng121");
			b.setAddress("http://opinion.people.com.cn/n1/2016/0627/c1003-28479597.html");
			b.setCorpus("不错不错哦");
			xinhua(b);
		}catch(Exception e){
			e.printStackTrace();
