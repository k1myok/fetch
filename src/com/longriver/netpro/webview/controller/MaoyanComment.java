...
public class MaoyanComment {
	...
	private static Logger logger = Logger.getLogger(MaoyanComment.class);
	...
	public static void main(String[] args) {
		...
		task.setNick("18216292940");
		task.setPassword("knmeow401");
		
		task.setAddress("http://maoyan.com/films/248170");
		task.setCorpus("期待复联三 等着看+1");
		task.setNick("15002237262");
		task.setPassword("fenglong1994");
		toComment(task);
	}
	...
	public static void toComment(TaskGuideBean task) {
		...
		try {
			String preCookie = paramMap.get("cookie");
		} catch (Exception e) {
//			isSuccess(task, "登录失败");
			return;
		}
...
//		String text = driver.findElement(By.xpath("//*[@id='app']/div/div[1]/div/div[2]/div[1]/div[5]/div[2]/a")).getText();
//		if("我的短评".equals(text)){
//			
